...
const pages=['index.html','personagens.html','lista-personagens.html','criacao-personagem.html','ficha-personagem.html','campanhas.html','mesa.html','sessoes.html','aventuras.html','dados.html','usuarios.html','bibliotecas.html'];
...
for(const href of['personagens.html','campanhas.html','sessoes.html','aventuras.html','bibliotecas.html','dados.html','usuarios.html'])assert.ok(home.includes(`href="${href}`),`Início sem acesso implementado: ${href}`);
assert.equal((home.match(/aria-disabled="true"/g)||[]).length,2,'Após o Bloco 15, somente Painel Geral e Configurações devem permanecer indisponíveis.');
...
for(const page of['campanhas.html','mesa.html','sessoes.html','aventuras.html','dados.html','usuarios.html','bibliotecas.html','personagens.html','lista-personagens.html']){
...
console.log('UX final validada: 12 superfícies responsivas, Etapas e navegação sticky mobile, acessibilidade, touch targets, hierarquia pós-criação e estados anunciáveis.');
