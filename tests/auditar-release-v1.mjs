...
for(const path of['README.md','ROADMAP-V1.md','docs/MANUAL.md','docs/ARQUITETURA.md','docs/HOMOLOGACAO-V1.md','docs/AUDITORIA-BRANCHES-V1.md','package.json','playwright.config.js','e2e/hub.spec.js','e2e/collaboration-real.spec.js','.github/workflows/homologar-release-v1.yml','.github/workflows/homologar-firebase-real.yml']){
...
const readme=read('README.md'),manual=read('docs/MANUAL.md'),architecture=read('docs/ARQUITETURA.md'),homologation=read('docs/HOMOLOGACAO-V1.md'),branches=read('docs/AUDITORIA-BRANCHES-V1.md');
...
for(const token of['#123','#94','#30','codex/bloco-1-ficha-modo-jogo','codex/bloco-16-painel-geral','delete ref'])assert.ok(branches.includes(token),`Auditoria de branches sem evidência: ${token}.`);
...
console.log('OK — gate estrutural do Bloco 18: documentação, E2E local, harness Firebase real, auditoria de branches e regressões críticas presentes e verdes.');
