...
storage.setItem('hub-rpg:collaboration-cache:v1',JSON.stringify({campaigns:{c1:{membership:{campaignId:'c1',username:'gus',email:'gus@teias.invalid',role:'player',characterId:'pc-gus',sessionIds:['s1'],adventureIds:['a1'],active:true},payload:{campaign:{id:'c1',name:'Mesa Gus',sessions:[{id:'s1'}]},revealedAdventures:[{id:'a1',campaignId:'c1',title:'Aventura Gus'}]}},c2:{membership:{campaignId:'c2',username:'leo',email:'leo@teias.invalid',role:'player',characterId:'pc-leo',active:true},payload:{campaign:{id:'c2',name:'Mesa Leo'},revealedAdventures:[]}}}}));
...
assert.equal(canOpenCharacter('pc-leo',storage),false);
...
console.log('OK — UI do Jogador usa somente Campanhas, Sessões, Aventuras e ficha explicitamente atribuídas.');