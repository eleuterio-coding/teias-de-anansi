...
const rules=fs.readFileSync('scripts/character-builder/rules.js','utf8'),ui=fs.readFileSync('scripts/character-builder/ranger-subclass-ui.js','utf8');
...
console.log('Integração de Patrulheiro validada: derive, Glamour feérico, iniciativa, Darkvision, combate, magias e pendências.');
