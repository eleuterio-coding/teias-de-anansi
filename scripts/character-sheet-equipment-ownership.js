...
import{ownedEquipment,ownedItemCount,formatOwnedRows,weaponAttackProfile}from'./character-builder/equipment-ownership.js?v=20260902-magic-items1';
...
if(typeof document!=='undefined'){
 ...
 for(const type of['hub-rpg:sheet-ready','hub-rpg:sheet-spells-ready','hub-rpg:inventory-transaction','hub-rpg:sheet-inventory-changed','hub-rpg:magic-items-changed'])document.addEventListener(type,()=>queueMicrotask(render));
 ...
 import('./character-sheet-magic-item-ui.js?v=20260902-magic-items1');
}
