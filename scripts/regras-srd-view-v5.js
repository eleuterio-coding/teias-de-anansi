...
const VERSION='20260820-srd521-regras5';
...
async function load(){
  ...
  const families=[...new Set([
    ...SRD.map(x=>x.tag?familyPT(x.tag):(ptRule(x.original)?.familia||'Regra Geral')),
    ...DDB_ONLY.map(x=>x.familia||'Regra Geral'),
    'Regra da Casa'
