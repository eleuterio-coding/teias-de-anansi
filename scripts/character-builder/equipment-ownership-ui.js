...
import{ownedEquipment,canUseArmor,canUseShield,canUseWeapon,weaponAttackProfile}from'./equipment-ownership.js?v=20260826-equipment-ownership1';
...
function normalizeActive(){
 ...
 if(eq.shield&&!ctx.shield){eq.shield=false;changed=true}
 return changed
}
function markup(){
