...
export function languageGrantDefinitions(){
 ...
 defs.push(...speciesLanguageDefinitions(species),{key:'core:languages',label:'Criação de Personagem',fixed:[],choose:2,pool:CORE_LANGUAGE_CHOICES},...backgroundLanguageDefinitions(bg));
