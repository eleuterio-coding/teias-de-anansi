...
function refreshCore(){const name=$('nome');if(name)name.dispatchEvent(new Event('input'));document.dispatchEvent(new CustomEvent('hub:spell-selection-changed'))}
