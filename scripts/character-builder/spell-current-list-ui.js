...
import{classSpellData,spellProgressionCandidates}from'./spell-progression-rules.js?v=20260825-spell-progression2';
...
function render(){
 ...
 panel.innerHTML=`<fieldset><legend>Lista atual de conjuração</legend><label>Buscar magia<input type="search" data-current-spell-search value="${esc(search)}" placeholder="Nome ou escola"></label>${cantripHtml(k,l,p,s)}${leveledHtml(k,l,p,s)}</fieldset>`
}
