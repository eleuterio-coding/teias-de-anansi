export const KEY='hub-rpg:characters:v4',LEGACY_KEYS=['hub-rpg:characters:v3','hub-rpg:characters:v2','hub-rpg:characters:v1'],V='20260831-warlock-invocations1',PIN='bfd3db4bcc31699cce703b46feb9af3f0ff08999';
...
export const state={catalogs:{classes:[],species:[],backgrounds:[],subclasses:[],feats:[],armors:[],weapons:[],spells:[],invocations:[]},c:null,warnings:[],G:{},LOCSP:{}};
