...
import{validatePortableRelations}from'./backup-relations.js?v=20260902-backup1';
...
export function createBackupPackage(storage=globalThis.localStorage,{metadata={}}={}){const base=unsignedPackage({data:readPortableData(storage),metadata});validatePortableRelations(base.data);return{...base,integrity:{algorithm:'fnv1a32',checksum:checksum(base)}}}
