...
MODULES=['regras.html','classes.html','subclasses.html','raca.html','antecedentes.html','talentos.html','maestrias-de-arma.html','monstros.html','armaduras.html','armas.html','equipamentos-aventura.html','ferramentas.html','montarias-veiculos.html','comercio-despesas.html','bugigangas.html','itens-magicos.html','magias.html','idiomas.html']
...
require('talentos-phb-2024.json' in feat_page and 'talentos-tasha-2020.json' in feat_page,'Biblioteca de talentos não cobre 5e/5.5e')
...
require('Espaços de Itens Mágicos' in magic_page,'Módulo de itens mágicos não aplica a substituição de Sintonização do Hub')

print(f'Auditoria 5e/5.5e concluída: {len(MODULES)} módulos presentes; {len(legacy_sub)} subclasses legadas únicas; política global e regras da casa alinhadas.')
