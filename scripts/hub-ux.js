...
async function setRealtime(active){
 ...
 if(!realtimeLoad)realtimeLoad=import('./collaboration-realtime.js?v=20260917-account-realtime1').then(module=>realtimeModule=module).catch(error=>{console.warn('[Hub realtime] bootstrap:',error);realtimeLoad=null;return null});
...
function bootstrapPageAccess(){const page=currentPage();if(page!=='ficha-personagem.html'||characterAccessLoad)return;characterAccessLoad=import('./character-sheet-access-ui.js?v=20260917-account-realtime1').catch(error=>{console.warn('[Hub access] ficha:',error);characterAccessLoad=null;return null})}
function mainTarget(){
