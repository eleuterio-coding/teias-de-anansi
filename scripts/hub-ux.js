...
async function setRealtime(active){
 ...
 if(!realtimeLoad)realtimeLoad=import('./collaboration-realtime.js?v=20260918-no-page-reload1').then(module=>realtimeModule=module).catch(error=>{console.warn('[Hub realtime] bootstrap:',error);realtimeLoad=null;return null});
