...
async function setRealtime(active){
 ...
 if(!realtimeLoad)realtimeLoad=import('./collaboration-realtime.js?v=20260917-global-realtime1').then(module=>realtimeModule=module).catch(error=>{console.warn('[Hub realtime] bootstrap:',error);realtimeLoad=null;return null});
