...
async function setRealtime(active){
 ...
 if(!realtimeLoad)realtimeLoad=import('./collaboration-realtime.js?v=20260922-adventure-workspace2').then(module=>realtimeModule=module).catch(error=>{console.warn('[Hub realtime] bootstrap:',error);realtimeLoad=null;return null});
...
function bootstrapPageAccess(){const page=currentPage();if(page!=='ficha-personagem.html'||characterAccessLoad)return;characterAccessLoad=import('./character-sheet-access-ui.js?v=20260918-master-delete1').catch(error=>{console.warn('[Hub access] ficha:',error);characterAccessLoad=null;return null})}
function mainTarget(){
